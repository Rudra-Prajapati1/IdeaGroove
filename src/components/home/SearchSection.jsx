    ...
    <div className="bg-white p-6 rounded-[2.5rem] shadow-[0_15px_50px_-15px_rgba(0,0,0,0.1)] border border-slate-50 max-w-6xl mx-auto font-sans">
      ...
      <div className="flex flex-col md:flex-row items-center gap-4">
        ...
        <div className="relative w-full md:w-auto">
          <select
            className="w-full md:w-auto pl-6 pr-14 py-4 bg-slate-50/80 border-none rounded-[1.5rem] text-slate-700 font-bold text-sm outline-none cursor-pointer appearance-none transition-all hover:bg-slate-50"
          >
        ...
        {/* More Filters Button */}
        <button className="flex items-center justify-center gap-3 w-full md:w-auto px-7 py-4 bg-slate-50/80 border-none rounded-[1.5rem] text-slate-700 font-bold text-sm hover:bg-slate-50 transition-all active:scale-95 shadow-sm">
