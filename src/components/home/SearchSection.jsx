    ...
    >
      <div className="flex flex-col md:flex-row items-center gap-4">
        ...
        <div className="relative w-full md:w-auto">
          <select className="w-full md:w-auto pl-6 pr-14 py-4 bg-slate-50/80 border-none rounded-3xl text-slate-700 font-bold text-sm outline-none cursor-pointer appearance-none transition-all hover:bg-slate-50">
