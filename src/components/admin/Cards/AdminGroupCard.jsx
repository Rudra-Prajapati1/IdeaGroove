      ...
      <div className="p-5 flex flex-col flex-1">
        ...
        <div className="flex justify-between items-start mb-4">
          <div className="flex items-center gap-2">
            <div
              className={`p-2 rounded-lg ${isActive ? "bg-emerald-50 text-emerald-600" : "bg-red-50 text-red-600"}`}
            >
        ...
        {/* Categories: Mapping Based_On and Room_Type */}
        ...
        {/* Metadata: Created_By and Created_On */}
