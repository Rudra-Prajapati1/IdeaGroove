...
const UserCard = ({ user, onModerate }) => {
  ...
  return (
    <div
      className={`group bg-white border border-gray-100 border-l-4 ${isActive ? "border-l-emerald-500" : "border-l-red-500"} rounded-xl p-4 flex items-center justify-between transition-all hover:shadow-lg hover:border-gray-200`}
    >
      <div className="flex items-center gap-4">
        {/* User Avatar - Mapping to Profile_Pic placeholder */}
        <div
        ...
        <div className="flex flex-col">
          <div className="flex items-center gap-2">
            <h4 className="font-bold text-gray-900 leading-tight group-hover:text-[#1B431C]">
              {user.name}
            </h4>
