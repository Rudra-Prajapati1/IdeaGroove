...
const ProfileInformation = () => {
  ...
  const infoFields = [
    { label: "EMAIL ADDRESS", value: user?.Email || "N/A", icon: <Mail size={16} /> },
    { label: "ROLL NUMBER", value: user?.Roll_No || "N/A", icon: <Hash size={16} /> },
    {
      label: "COLLEGE NAME",
    ...
    { label: "DEGREE", value: user?.Degree || "B.Tech Computer Science", icon: <GraduationCap size={16} /> },
    { label: "COLLEGE YEAR", value: user?.Year || 2026, icon: <Calendar size={16} /> },
  ];
        ...
        <div className="px-10 py-10 flex flex-col md:flex-row gap-12">
          ...
          <div className="flex flex-col items-center">
            <div className="relative group">
              <div className="w-44 h-44 rounded-4xl bg-[#FFAB8F] overflow-hidden border-[6px] border-[#e8f5e9] shadow-inner">
                <img src={user?.Profile_Pic || defaultProfilePic} alt="Profile" className="w-full h-full object-cover" />
              </div>
            ...
            <div className="mt-6 text-center">
              <h3 className="text-2xl font-black text-[#1A3C20]">{user?.Name || "Alex Johnson"}</h3>
              <p className="text-gray-400 font-medium text-sm mt-1">{user?.Username || "alexj"}</p>
            </div>
          </div>
          ...
          <div className="flex-1">
              ...
              <div className="md:col-span-2">
                ...
                <div className="flex flex-wrap gap-2">
                  {hobbies.map((hobby, idx) => (
                    <span key={idx} className="px-5 py-2 bg-[#e8f5e9] text-[#1A3C20] text-xs font-bold rounded-full border border-[#1A3C20]/5 hover:bg-[#1A3C20] hover:text-white transition-colors">
                      {hobby}
                    </span>
                  ))}
                </div>
            ...
            <div className="mt-12 pt-8 border-t border-gray-100">
              <h4 className="text-[10px] font-black text-red-400 tracking-[0.15em] mb-4 uppercase">Danger Zone</h4>
              <button 
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
          <div className="bg-white rounded-[2rem] max-w-md w-full p-8 shadow-2xl relative animate-in fade-in zoom-in duration-200">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-2xl font-black text-[#1A3C20] mb-2">Are you sure?</h3>
              <p className="text-gray-500 text-sm mb-8 leading-relaxed">
                This action is permanent and cannot be undone. All your progress, posts, and profile data will be deleted forever.
              </p>
